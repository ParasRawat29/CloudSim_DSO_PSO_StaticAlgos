...
/**
 * CloudletCreator Creates Cloudlets as per the User Requirements. More Long
 * tasks then short tasks which makes min-min outperform max-min
 *
 */
public class CloudletCreator2 {
	...
	public ArrayList<Cloudlet> createUserCloudlet(int reqTasks, int brokerId) {
		...
		for (id = 0; id < reqTasks; id++) {
			...
			Cloudlet task = new Cloudlet(id, length[id], pesNumber, fileSize, outputSize, utilizationModel,
